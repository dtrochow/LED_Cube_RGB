...
public:
    CartesianCoordinates(int x_, int y_, int z_) : x(x_), y(y_), z(z_) {};
    int x;
    int y;
    int z;
...
public:
    CuboidCoordinates(CartesianCoordinates& cr_start_, CartesianCoordinates& cr_end_) : start(cr_start_), end(cr_end_){};
